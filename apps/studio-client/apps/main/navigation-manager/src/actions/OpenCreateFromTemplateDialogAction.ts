...
interface OpenCreateFromTemplateDialogActionConfig extends Config<OpenCreateFromTemplateDialogActionBase>, Partial<Pick<OpenCreateFromTemplateDialogAction,
...
class OpenCreateFromTemplateDialogAction extends OpenCreateFromTemplateDialogActionBase {
  ...
  constructor(config: Config<OpenCreateFromTemplateDialogAction> = null) {
    ...
    const this$ = this;
    super(ConfigUtils.apply(Config(OpenCreateFromTemplateDialogAction, {
      ...
      dialog: Config(CreateFromTemplateDialog, { listeners: { "afterrender": bind(this$, this$.updateProcessingData) } }),
    }), config));
  }
